...
/* harmony import */ var _modules_formatDate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/formatDate.js */ "./src/modules/formatDate.js");
...
async function populateWeatherElements(city) {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    getForecastWeather().then((resp) => {
      ...
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(forecastDate))) {
        date.innerHTML = 'Today';
      } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(forecastDate))) {
        date.innerHTML = 'Tomorrow';
      } else {
        date.innerHTML = (0,_modules_formatDate_js__WEBPACK_IMPORTED_MODULE_1__.formatDate)(forecastDate);
      }
      ...
      highlightDate.innerHTML = `<p>Last updated:</p><p>${(0,_modules_formatDate_js__WEBPACK_IMPORTED_MODULE_1__.formatCurrentDay)(currentLastUpdated)} ${(0,_modules_formatDate_js__WEBPACK_IMPORTED_MODULE_1__.formatCurrentTime)(currentLastUpdated)}</p><p>${(0,_modules_formatDate_js__WEBPACK_IMPORTED_MODULE_1__.formatDate)(forecastDate)}</p>`;
